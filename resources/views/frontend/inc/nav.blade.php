            ...
            <div class="d-flex h-100">
                ...
                <div class="ml-xl-4 w-100">
                    <div class="d-flex align-items-center justify-content-center justify-content-xl-start h-100">
                        ...
                        <ul class="list-inline mb-0 pl-0 c-scrollbar-light">
                            @if (get_setting('header_menu_labels') != null)
                                ...
                                @endphp
                                @foreach ($menu_labels as $key => $value)
                                    @php
                                        $link = $menu_links[$key];
                                    ...
                                    <li class="list-inline-item mr-0">
                                        ...
                                        <a href="{{ $link }}"
                                           class="fs-13 px-3 py-3 d-inline-block fw-700
                                           {{ $nav_txt_color }} header_menu_links hov-bg-black-10
                @if ($currentUrl == $link || ($link == '/' && $currentUrl == $baseUrl)) active @endif">
                                            {{ translate($value) }}
                                        </a>
                                    </li>
                                @endforeach
                ...
                <!-- Cart -->
                <div style="background-color:white; color: #EE6431; border: 1px solid #EE6431"
                     class="d-none d-xl-block align-self-stretch ml-5 mr-0 has-transition"
                     data-hover="dropdown">
