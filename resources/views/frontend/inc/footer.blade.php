...
@php
    $col_values = ((get_setting('vendor_system_activation') == 1) || addon_is_activated('delivery_boy')) ? "col-lg-4 col-md-6 col-sm-6" : "col-md-4 col-sm-6";
@endphp
            ...
            <div class="col-md-6">
                ...
                <div class=" col-xl-5 col-lg-4">
                    ...
                    @if ( get_setting('show_social_links') )
                        ...
                        <ul class="list-inline social colored mb-4 pt-2">
                            ...
                            @if (!empty(get_setting('twitter_link')))
                                <li class="list-inline-item mb-2 mr-2">
                                    <a href="{{ get_setting('twitter_link') }}" target="_blank"
                                       class="twitter"><i class="fa-brands fa-x-twitter"></i></a>
                                </li>
                            @endif
                ...
                <div class="row  justify-content-end">
                    ...
                    <div class="{{ $col_values }}">
                        <div class="text-center text-sm-left mt-4">
                            <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('About Us') }}</h4>
                    ...
                    <div class="{{ $col_values }}">
                        <div class="text-center text-sm-left mt-4">
                            <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('Services') }}</h4>
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <a class="fs-13 text-soft-light text-capitalize animate-underline-white"
                                       href="{{ route('returnpolicy') }}">
                    ...
                    <div class="{{ $col_values }}">
                        <div class="text-center text-sm-left mt-4">
                            <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('Customer Support') }}</h4>
                            <ul class="list-unstyled">
                                <li class="mb-2">
                                    <i class="fa-solid fa-envelope"></i>
                                    <a class="fs-13 text-soft-light animate-underline-white"
                                       href="mailto:support@partzona.com">
                                        support@partzona.com
                                    </a>
                                </li>
                                <li class="mb-2">
...
<footer class="pt-3 pb-7 pb-xl-3 bg-black text-soft-light">
    <div class="container">
        <div class="text-center text-white fs-14" current-verison="{{get_setting("current_version")}}">
