...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="aiz-pagination mt-4">
                            ...
                            <div class="aiz-pagination mt-4">
                                @if(isset($category->pagination) && $category->pagination)
                                ...
                                @else
                                    <?php
                                        ...
                                        ?>
                                    <div class="custom-svg-pagination">
                                        <!-- Previous Button -->
                                        <a href="{{ $page <= 1 ? '#' : url()->current().'?'.http_build_query(array_merge($queryParams, ['page' => $page - 1])) }}"
                                           class="pagination-btn"
                                           @if($page <= 1) disabled @endif>
                                            <svg class="arrow-left" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!-- Next Button -->
                                        <a href="{{ url()->current().'?'.http_build_query(array_merge($queryParams, ['page' => $page + 1])) }}"
                                           class="pagination-btn">
                                            <span>Next</span>
                                            <svg class="arrow-right" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <style>
        ...
        .pagination-btn:hover:not([disabled]) .arrow-left {
            transform: translateX(-2px);
        }

        .pagination-btn:hover:not([disabled]) .arrow-right {
            transform: translateX(2px);
        }
    </style>
