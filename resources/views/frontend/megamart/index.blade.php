...
@section('content')
    <style>
        ...
        @media (min-width: 1200px) {
            #hero_section .carousel-box > a > div {
    ...
    <!-- Sliders -->
    <div id="hero_section" class="home-banner-area mb-3" style="background-color: {{ get_setting('slider_section_bg_color', '#dedede') }}">
                ...
                <div class="container">
                    <div class="border">
                        ...
                        <div class="d-sm-flex bg-white pb-3 pb-md-4">
                            ...
                            <!-- Products -->
                            <div class="px-0 px-sm-4 w-100 overflow-hidden 1111">
