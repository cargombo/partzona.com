...
{{--                    @dd(json_decode($detailedProduct->choice_options) )--}}
                ...
                <!-- Color Options -->
                @if ($detailedProduct->colors != null && $filtered_colors != null && count(json_decode($detailedProduct->colors)) > 0)
                    <div class="row no-gutters mb-3">
                        <div class="col-sm-2">
...
{{--                                            <span class="size-25px d-inline-block rounded" style="background: {{ $color }};"></span>--}}
                                                <span class="d-inline-block rounded">{{$color}}</span>
{{--                                            <span class="size-25px d-inline-block rounded" style="background-image: url('{{get_single_color_image($color)}}');background-size: cover;background-position: center;display: inline-block;"></span>--}}
                                        </span>
                                        </label>
                                @endforeach
                            </div>
