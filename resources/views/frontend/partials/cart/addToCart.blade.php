            ...
            <div class="text-left">
                ...
                <form id="option-choice-form">
                    ...
                    @if($product->digital !=1)
                        ...
                        <!-- Color -->
                        @if ($product->colors && $filtered_colors != null && count(json_decode($product->colors)) > 0)
                            <div class="row no-gutters mt-3">
                                <div class="col-3">
...
{{--                                                <span class="size-25px d-inline-block rounded" style="background: {{ $color }};"></span>--}}
                                                                  <span class="size-25px d-inline-block rounded"
                                                                        style="background-image: url('{{get_single_color_image($color)}}');background-size: cover;
