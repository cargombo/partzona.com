    ...
    <script type="text/javascript">
        @can('edit_measurement_points')
            function edit_measurement_point(id){
                ...
                let http_problem = true;
                var actionUrl = (http_problem ? "https://shop.ini.az/admin/measurement-points/" : "{{ route('measurement-points.update', '') }}/")+id
                $.ajax({
                    type: "GET",
                    url: (http_problem ? "https://shop.ini.az/admin/measurement-points/" : "{{ route('measurement-points.show', '') }}/")+id,
                    data: {},
