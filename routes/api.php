...
//    Route::any('payriff/payment/callback', 'App\Http\Controllers\Api\V2\PayriffController@callback')->name('payriff.callback.callback');
    Route::any('payriff/payment/callback/approve', 'App\Http\Controllers\Api\V2\PayriffController@approve')->name('payriff.callback.approve');
    Route::any('payriff/payment/callback/cancel', 'App\Http\Controllers\Api\V2\PayriffController@cancel')->name('payriff.callback.cancel');
    Route::any('payriff/payment/callback/decline', 'App\Http\Controllers\Api\V2\PayriffController@decline')->name('payriff.callback.decline');
});
...
Route::prefix('tz')->group(function () {
    Route::post('/update-status', [TazbeebexController::class, 'updateStatus']);
});
