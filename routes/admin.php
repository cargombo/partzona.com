...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/orders/create-delivery', 'create_delivery')->name('orders.create_delivery');
        Route::post('/orders/update-delivery-number', 'update_delivery_number')->name('orders.update_delivery_number');
        Route::get('/orders/get-deliveries', 'get_deliveries')->name('orders.get_deliveries');
        Route::get('/orders/delete-delivery', 'delete_delivery')->name('orders.delete_delivery');
        Route::get('/orders/get-delivery-details', 'get_delivery_details')->name('orders.get_delivery_details');
