...
class AuthController extends Controller
{
    public function signup(Request $request)
    {
        ...
        if(!in_array($request->gender,["male","female"])){
            return response()->json([
               "result" => false,
               "message" => [translate("Gender is not valid")]
            ]);
        }
...
//        $customer_condition = $request->has('user_type') && $request->user_type == 'customer';
        $customer_condition = !$delivery_boy_condition && !$seller_condition;
...
//        dd($delivery_boy_condition,$seller_condition);
        // if (!$delivery_boy_condition) {
        if (!$delivery_boy_condition && !$seller_condition && !$customer_condition) {
