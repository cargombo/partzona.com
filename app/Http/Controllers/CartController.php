...
class CartController extends Controller
{
    ...
    public function showCartModal(Request $request)
    {
        ...
        ScrapeInsertionService::insertProduct($product->slug);

        $colors = [];

        $decodedColors = is_string($product->colors) ? json_decode($product->colors, true) : [];
        ...
        return view('frontend.partials.cart.addToCart', compact('product', 'filtered_colors'));
    }
    ...
    public function addToCart(Request $request)
    {
        ...
        //check the color enabled or d
        //isabled for the product
        $str = CartUtility::create_cart_variant($product, $request->all());
//        dd($str,$product,$request->all());
